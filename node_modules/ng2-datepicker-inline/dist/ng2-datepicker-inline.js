import { Component, Directive, ElementRef, EventEmitter, HostListener, Inject, InjectionToken, Input, NgModule, Optional, Output, Renderer, ViewContainerRef, forwardRef } from '@angular/core';
...
import { addMonths, eachDay, endOfMonth, format, getDate, getDay, getMonth, getYear, isAfter, isBefore, isSameDay, isSameMonth, isSameYear, isToday, setDay, setYear, startOfMonth, subDays, subMonths } from 'date-fns';
...
class NgDatepickerInlineComponent {
    /**
     * @param {?} elementRef
     */
    ...
    init() {
        ...
        let /** @type {?} */ isSelectedInput = function (date) {
            let /** @type {?} */ isSelected = function (date, value) {
        ...
        let /** @type {?} */ isStartDate = function (date) {
            if (this.innerValue instanceof Date) {
                return false;
            }
            else {
        ...
        let /** @type {?} */ isEndDate = function (date) {
            if (this.innerValue instanceof Date) {
                return false;
            }
            else {
        ...
        let /** @type {?} */ isInRange = function (date) {
            if (this.innerValue instanceof Date) {
                return false;
            }
            else {
 ...
 * @nocollapse
 */
NgDatepickerInlineComponent.ctorParameters = () => [
    { type: ElementRef, },
];
...
class NgDatepickerInlineModule {
}
 ...
 * @nocollapse
 */
NgDatepickerInlineModule.ctorParameters = () => [];

/**
 * Generated bundle index. Do not edit.
 */

export { NgDatepickerInlineModule, NgDatepickerInlineComponent };
//# sourceMappingURL=ng2-datepicker-inline.js.map
