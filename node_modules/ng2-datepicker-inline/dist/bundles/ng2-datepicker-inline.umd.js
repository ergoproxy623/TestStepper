(function (global, factory) {
	...
	(factory((global['ng2-datepicker-inline'] = {}),global.ng.core,global.ng.common,global.ng.forms,global.Rx,global.Rx,global.Rx.Observable,global.Rx.Observable,global.Rx.Observable.prototype,global.Rx.Observable.prototype,global.Rx.Observable.prototype,global.dateFns));
...
var NgDatepickerInlineComponent = /** @class */ (function () {
    /**
     * @param {?} elementRef
     */
    function NgDatepickerInlineComponent(elementRef) {
    ...
    Object.defineProperty(NgDatepickerInlineComponent.prototype, "value", {
        /**
         * @return {?}
         */
        get: function () {
     ...
     * @return {?}
     */
    NgDatepickerInlineComponent.prototype.ngOnInit = function () {
        this.view = 'days';
        this.date = new Date();
        this.setOptions();
        this.initDayNames();
     ...
     * @return {?}
     */
    NgDatepickerInlineComponent.prototype.ngOnChanges = function (changes) {
     ...
     * @return {?}
     */
    NgDatepickerInlineComponent.prototype.setOptions = function () {
     ...
     * @return {?}
     */
    NgDatepickerInlineComponent.prototype.nextMonth = function () {
     ...
     * @return {?}
     */
    NgDatepickerInlineComponent.prototype.prevMonth = function () {
     ...
     * @return {?}
     */
    NgDatepickerInlineComponent.prototype.setDate = function (i) {
     ...
     * @return {?}
     */
    NgDatepickerInlineComponent.prototype.setYear = function (i) {
     ...
     * @return {?}
     */
    NgDatepickerInlineComponent.prototype.isDateSelectable = function (date) {
     ...
     * @return {?}
     */
    NgDatepickerInlineComponent.prototype.init = function () {
        var _this = this;
        var /** @type {?} */ start = dateFns.startOfMonth(this.date);
        var /** @type {?} */ end = dateFns.endOfMonth(this.date);
        var /** @type {?} */ isSelectedInput = function (date) {
            var /** @type {?} */ isSelected = function (date, value) {
                return dateFns.isSameDay(date, value) && dateFns.isSameMonth(date, value) && dateFns.isSameYear(date, value);
            };
        ...
        var /** @type {?} */ isStartDate = function (date) {
            if (this.innerValue instanceof Date) {
                return false;
            }
            else {
                return dateFns.isSameDay(date, this.innerValue[0]) && dateFns.isSameMonth(date, this.innerValue[0]) && dateFns.isSameYear(date, this.innerValue[0]);
            }
        };
        var /** @type {?} */ isEndDate = function (date) {
            if (this.innerValue instanceof Date) {
                return false;
            }
            else {
                return dateFns.isSameDay(date, this.innerValue[1]) && dateFns.isSameMonth(date, this.innerValue[1]) && dateFns.isSameYear(date, this.innerValue[1]);
            }
        };
        var /** @type {?} */ isInRange = function (date) {
            if (this.innerValue instanceof Date) {
                return false;
            }
            else {
                if (this.innerValue[0] instanceof Date && this.innerValue[1] instanceof Date) {
                    return dateFns.isAfter(date, this.innerValue[0]) && dateFns.isBefore(date, this.innerValue[1]);
                }
                else {
                    return false;
                }
        ...
        this.barTitle = !isDateEmpty.call(this) ? dateFns.format(start, this.barTitleFormat, this.locale) : this.barTitleIfEmpty;
    };
    /**
     * @return {?}
     */
    NgDatepickerInlineComponent.prototype.initYears = function () {
        var _this = this;
     ...
     * @return {?}
     */
    NgDatepickerInlineComponent.prototype.initDayNames = function () {
        this.dayNames = [];
     ...
     * @return {?}
     */
    NgDatepickerInlineComponent.prototype.toggleView = function () {
     ...
     * @return {?}
     */
    NgDatepickerInlineComponent.prototype.writeValue = function (val) {
        if (val) {
            ...
            this.innerValue = val;
            this.init();
            this.barTitle = dateFns.format(dateFns.startOfMonth(this.date), this.barTitleFormat, this.locale);
        }
    };
    /**
     * @param {?} fn
     * @return {?}
     */
    NgDatepickerInlineComponent.prototype.registerOnChange = function (fn) {
 ...
 * @nocollapse
 */
NgDatepickerInlineComponent.ctorParameters = function () { return [
    { type: core.ElementRef, },
]; };
NgDatepickerInlineComponent.propDecorators = {
    'options': [{ type: core.Input },],
    'headless': [{ type: core.Input },],
};
var NgDatepickerInlineModule = /** @class */ (function () {
    function NgDatepickerInlineModule() {
    }
    return NgDatepickerInlineModule;
}());
NgDatepickerInlineModule.decorators = [
    { type: core.NgModule, args: [{
                declarations: [NgDatepickerInlineComponent],
                imports: [common.CommonModule, forms.FormsModule, NgSlimScrollModule],
                exports: [NgDatepickerInlineComponent, common.CommonModule, forms.FormsModule, NgSlimScrollModule]
            },] },
];
/**
 * @nocollapse
 */
NgDatepickerInlineModule.ctorParameters = function () { return []; };

exports.NgDatepickerInlineModule = NgDatepickerInlineModule;
exports.NgDatepickerInlineComponent = NgDatepickerInlineComponent;

Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=ng2-datepicker-inline.umd.js.map
